...
import com.example.dabashop.adapters.CartProductAdapter
import com.example.dabashop.databinding.FragmentCartBinding
import com.example.dabashop.firebase.FirebaseCommon
import com.example.dabashop.util.Resource
import com.example.dabashop.util.VerticalItemDecoration
import com.example.dabashop.viewmodel.CartViewModel
        ...
        lifecycleScope.launchWhenStarted {
            viewModel.deleteDialog.collectLatest {
                val alertDialog = AlertDialog.Builder(requireContext()).apply {
                    setTitle("El articulo se ha eliminado del carrito")
                    setMessage("¿Quieres eliminar este articulo del carrito?")
