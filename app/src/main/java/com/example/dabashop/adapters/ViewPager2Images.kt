...
import com.example.dabashop.databinding.ViewpagerImageItemBinding
...
class ViewPager2Images : RecyclerView.Adapter<ViewPager2Images.ViewPager2ImagesViewHolder>() {
    ...
    private val diiffCallback = object : DiffUtil.ItemCallback<String>(){
    ...
    val differ = AsyncListDiffer(this,diiffCallback)
